This app will pull information from an external API (https://newsapi.org/) for different news sources based on the user input. It will default to UK > General when the page loads until chaged. 
